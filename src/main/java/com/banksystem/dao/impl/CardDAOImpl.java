...
public class CardDAOImpl implements CardDAO {
    ...
    private final static String GET_CARDS = "SELECT cr.id, " +
            "cr.number, " +
            "cr.amount, " +
            "cr.currency, " +
            "cr.expiration_date " +
    ...
    @Override
    public List<CardDTO> readAllCards() throws DAOException {
        final String query = GET_CARDS;
        List<CardDTO> cards = new ArrayList<>();
        DBManager dbm;
        Connection con = null;
        Statement stmt = null;
        ...
        try {
            ...
            DBManager.rollback(con);
            throw new DAOException("Can't get Cards ", ex);
        } finally {
